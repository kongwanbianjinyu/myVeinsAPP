...
#include "veins/modules/application/traci/ReqJoinMessage_m.h"
#include "veins/modules/application/traci/ACKJoinMessage_m.h"
...
public:
    ...
    enum DemoApplMessageKinds {
        SEND_BEACON_EVT,
        SEND_WSA_EVT,
        SEND_BEACON_END,//when T_collect == 0, stop exchanging beacon
        CHA_BOARDCAST,
        SEND_REQJOIN_EVT,
        SEND_ACKJOIN_EVT,
        ACK_TIME_EXPIRE
...
protected:
    ...
    /** @brief this function is called upon receiving a CHAMessage  */
    virtual void onCHA(CHAMessage * CHA){};

    /** @brief this function is called upon CH receiving a ReqJoinMessage from CCM */
    virtual void onReqJoin(ReqJoinMessage * ReqJoin){};

    /** @brief this function is called upon CH receiving a ReqJoinMessage from CCM */
    virtual void onACKJoin(ACKJoinMessage * ACKJoin){};
...
protected:
    ...
    cMessage* sendWSAEvt;
    cMessage* sendBeaconEnd;
    cMessage* CHABoardcast;
    cMessage* sendReqJoinEvt;
    cMessage* sendACKJoinEvt;
    cMessage* ACKTimeExpire;
